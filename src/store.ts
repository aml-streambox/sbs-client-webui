...
export async function updatePreviewEncoderConfig(config: { auto_downscale?: boolean; downscale_factor?: number; framerate?: number; bitrate_kbps?: number }, profileId?: string) {
